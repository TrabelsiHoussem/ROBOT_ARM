...
def processFeedback(feedback):
    ...
    if feedback.event_type == InteractiveMarkerFeedback.MENU_SELECT:
        if feedback.menu_entry_id==1:
            ...
            listener.waitForTransform('/Link_5','/odom',rospy.Time(), rospy.Duration(1.0))
            (trans,rot)=listener.lookupTransform('odom','Link_5',rospy.Time())
            print trans,rot
...
if __name__=="__main__":
	...
	listener.waitForTransform('/Link_5','/odom',rospy.Time(), rospy.Duration(1.0))
	print listener.frameExists('odom')
	print listener.frameExists('Link_5')
	(trans,rot)=listener.lookupTransform('odom','Link_5',rospy.Time())
	print trans,rot
